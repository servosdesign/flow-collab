...
import type { SyncFlowDocument, SyncNode } from '@vue-flow-sync/shared'
...
export const createRemoteDocumentSync = (
  runtime: FlowRuntime,
  ...
  const applyRemoteGranularNodeOperation = (
    operation: JsonOp[],
    document: SyncFlowDocument
  ) => {
