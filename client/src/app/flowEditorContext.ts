...
const useRequiredContext = <T>(key: InjectionKey<T>, name: string) => {
...
export const provideFlowEditorContexts = (editor: FlowEditorViewModels) => {
...
export const useCanvasSurfaceContext = () => {
  return useRequiredContext(canvasSurfaceKey, 'Canvas surface context')
}

export const useCanvasOverlayContext = () => {
